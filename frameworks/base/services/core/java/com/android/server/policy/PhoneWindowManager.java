    ...
    private void powerLongPress(long eventTime) {
        ...
        switch (behavior) {
            ...
            case LONG_PRESS_POWER_GLOBAL_ACTIONS:
                ...
                // Block the Power Menu if the lockscreen is active
                if (mKeyguardDelegate != null && mKeyguardDelegate.isShowing()) {
                    Slog.i(TAG, "Global Actions blocked: Device is on lockscreen");
                    break; // Exits the switch without showing the menu
                }
            ...
            case LONG_PRESS_POWER_SHUT_OFF_NO_CONFIRM:
                ...
                // --- CUSTOM MODIFICATION START ---
                // Block direct shut-off if the lockscreen is active
                if (mKeyguardDelegate != null && mKeyguardDelegate.isShowing()) {
                    Slog.i(TAG, "Direct Shut Off blocked: Device is on lockscreen");
                    break; 
                }
                // --- CUSTOM MODIFICATION END ---
    ...
    private void powerVeryLongPress() {
        ...
        switch (mVeryLongPressOnPowerBehavior) {
            ...
            case VERY_LONG_PRESS_POWER_GLOBAL_ACTIONS:
                ...
                // --- CUSTOM MODIFICATION START ---
                // Block the Power Menu on very long press if the lockscreen is active
                if (mKeyguardDelegate != null && mKeyguardDelegate.isShowing()) {
                    Slog.i(TAG, "Global Actions blocked on very long press: Device is on lockscreen");
                    break; 
                }
                // --- CUSTOM MODIFICATION END ---
